...
$(document).ready(function() {
	...
	$('.btn').on('click', function(e) {
		...
		sound.innerHTML = '<audio autoplay><source src="audio/bubbles.wav" type="audio/wav"></audio>';
	});
	...
	$('#canvas').on('click', function(e) {
		...
		_.each(bubbles, function(b, i) {
			if (clickX < b.x + b.size && clickX > b.x - b.size && 
				clickY < b.y + b.size && clickY > b.y - b.size) {
				b.pop(i);
			}
		});
	});
	...
	function Bubble() {
		...
		this.pop = function(i) {
			sound.innerHTML = '<audio autoplay><source src="audio/pop.wav" type="audio/wav"></audio>';
